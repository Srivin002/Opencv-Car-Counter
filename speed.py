...
import sys
sys.path.append('C:/DLProjects/OpenCV/Projects py')     #C:\DLProjects\OpenCV\Projects py
from Counting_cars.tracker import Tracker
import time
import csv
...
# Video capture setup
cap = cv2.VideoCapture('C:/DLProjects/OpenCV/Projects py/Counting_cars/SINGLE LINE.mp4')
...
my_file = open("C:/DLProjects/OpenCV/Projects py/Counting_cars/coco.txt", "r")
data = my_file.read()
